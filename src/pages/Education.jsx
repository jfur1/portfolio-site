        ...
        <div className="main">
            <Fade bottom duration={1600}>
                <div className="tab-main mb-5">
                    <div className="skills-img edu">
                        <img src={EducationPng} alt="education" width="100%"/>
                    </div>
            ...
            <Fade bottom duration={1600}>
                <div className="edu-container">
                    <div className="tab-img mt-1" style={{textAlign: "center"}}>
                    ...
                    <div className="edu-card">
                        <div className="edu-card-header">
                            <div className="edu-card-title">
                                ...
                                <h4 className="px-3">B.A. in Computer Science</h4>
                            </div>
                            <div className="edu-card-date pl-2" style={{alignSelf: "center"}}>
                                <h6>2016-2020</h6>
                            </div>
                        </div>
                ...
                <Fade bottom duration={1800} delay={300}>
                    <div style={{textAlign: "center"}}>
                        <h2 className="mt-5 mb-1 pt-5">Certifications</h2>
                    </div>
                </Fade>
